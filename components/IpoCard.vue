  ...
  >
    <div class="card-content">
      ...
      <div class="ipo-status" :class="getIpoStatus(ipo).class">
        ...
        <svg v-if="activeTab !== 'pipeline'" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke-width="3"
             stroke="currentColor">
    ...
    <div v-if="isLoading" class="actions-spinner-container">
